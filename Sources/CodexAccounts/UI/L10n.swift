...
struct L10n {
    ...
    private static let zhHans: [L10nKey: String] = [
        ...
        .showDailyUsageBaselineHelp: "默认关闭；开启后应用会在本地时区每天 0 点后自动刷新一次额度作为当天基线，最多保留最近 8 天记录",
        .dailyUsageBaselineHelpFormat: "今日已用 %@ · 基线 %@",
        .shareCodexData: "共享记录和状态",
        .shareCodexDataDetail: "会话、goal、缓存、插件、技能",
        .shareCodexDataHelp: "共享会话、goal、memories、附件、automations、worktrees、skills、plugins、图片和缓存；不共享登录、配置、环境变量、日志和 SQLite 运行库",
    ...
    private static let en: [L10nKey: String] = [
        ...
        .showDailyUsageBaselineHelp: "Off by default; after local midnight, the app automatically refreshes usage once and records it as that day's baseline, keeping at most the last 8 days",
        ...
        .shareCodexDataHelp: "Shares sessions, goals, memories, attachments, automations, worktrees, skills, plugins, images, and cache; does not share auth, config, environment, logs, or live SQLite databases",
